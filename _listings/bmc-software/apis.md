...
apis:
- name: BMC Software Merged API - Perform batch
  x-api-slug: v1batch-post
  description: |-
...
- name: BMC Software Merged API - Create metrics batch
  x-api-slug: v1batchmetrics-post
...
- name: BMC Software Merged API - Update metrics batch
  x-api-slug: v1batchmetrics-put
