...
created: "2018-06-25"
modified: "2018-06-25"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/batch/master/_listings/uk-national-archives/apis.md
...
- name: Getty Images Search API Put Usage Batches
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/batch/master/_listings/uk-national-archives/v3usagebatchesid-put-openapi.md
- name: Getty Images Search API
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/batch/master/_listings/uk-national-archives/openapi.md
x-common:
- type: x-website
